...
% Generate random indices for train and test
[ntrain,nval]= gen_rand_indices(1962,20);
...
% Composition-elemental features will be used for mixed network
Xtrain = combine(itrain,ftrain,Ytrain);
Xval = combine(ival,fval,Yval);
